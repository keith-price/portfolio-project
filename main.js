...
let earth;
earthLoader.load(
	'/textures/planet_earth_alt-drag_to_change_lighting/scene.gltf',
	(gltf) => {
		earth = gltf.scene;
...
let lunarModule;
lunarLoader.load(
	'/textures/apollo_lunar_excursion_module/scene.gltf',
	(gltf) => {
		lunarModule = gltf.scene;
		lunarModule.scale.set(0.001, 0.001, 0.001);
		lunarModule.rotateX(0.14);
		lunarModule.rotateZ(0.3);

		lunarModule.position.set(9.8, 0.99, 0.064);

		lunarModule.receiveShadow = true;
		lunarModule.castShadow = true;
